...
app.get('/showData', (req, res, next) => {
    res.json({products1: [{id: "item1", btn_id:"Fuchsite Natural Single Gemstone Rs.1399",title:"Fuchsite Natural Single Gemstone", price:"Rs 1,399/-", imageUrl:"https://tse4.mm.bing.net/th?id=OIP.yS_3usllFbfNbyF-ZqfS_QHaJ4&pid=Api&P=0"},
    ...
    products2:[{id: "item1", btn_id:"Indian Apophyllite Crystal Rs.1200",title:"Indian Apophyllite Crystal", price:"Rs.1,200/-", imageUrl:"https://tse3.mm.bing.net/th?id=OIP.vty7MC8m3H5ChKIelllUGQHaHY&pid=Api&P=0"},
